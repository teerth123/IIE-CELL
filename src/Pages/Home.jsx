...
export default function Home(){
    ...
    return(
        <>
            <MainHeroSection/>
            <div className="flex bg-white font-handlee mt-[5vw] pt-[5vw] pl-20 justify-center pb-32">
                <div>
                    <div className="headling font-poppins text-3xl font-bold pb-5 mt-32">Vision & Mission of IIE Cell at Walchand College of Engineering, Sangli</div>
                    <div className="draft text-[22px] max-w-[50vw]">
                        <h1 className="mb-5">
